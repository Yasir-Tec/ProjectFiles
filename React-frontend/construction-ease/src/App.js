      ...
      <div className="App">
       <HeaderComponent></HeaderComponent>
         ...
         <Routes>
            ...
            <Route path='/dashboard'element={<SideBarComponent></SideBarComponent>}></Route>
           <Route path='/admin' element={<Home></Home>}></Route>
           <Route path='/dashboard/user' element={<ListContractorsComponent></ListContractorsComponent>}></Route>
